...
# Your code here
files_list <- list.files(path = "/Users/hallgerdur.kolbeinsdottir/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Dokument/Courses_PhD/HK_IntermediateR_assignments_git/tidyverse_task_monday_260427/data/Timeseries_data", pattern = ".csv", full.names = TRUE, recursive = T)
files_list
